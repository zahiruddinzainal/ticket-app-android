...
public class UserViewAdapter extends RecyclerView.Adapter<UserViewAdapter.ImageViewHolder> {
    ...
    public UserViewAdapter(Context context, List<Upload> uploads) {
        mContext = context;
        mUpload = uploads;
    }
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.user_view_adapter, parent, false);
    ...
    public void onBindViewHolder(final ImageViewHolder holder , int pos) {
        ...
        holder.mAddToCart.setTag(pos); // set and store unique position of button.. nak guna dekat ---> userview.java
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageViewHolder(View itemView) {
            ...
            mAddToCart = itemView.findViewById(R.id.addToCartButton);
